...
emmm 这就是纯写代码的一篇文章，直接上代码了，前面课堂上的海东老师讲的我就直接 CV 了
...
WOW 对应的 ASCII 码用十六进制表示依次为：0x57，0x4F，0x57（**这里要注意：基本数据类型 int short 等再内存中数据是反着存的，但是字符串在内存中从低地址到高地址就是字符串的顺序，不要和前面搞混了**）

![](Screenshot_3-1024x625.png)
