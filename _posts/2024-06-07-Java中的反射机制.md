...
其中`initialize`参数是`false`，那么就不会去初始化该类，`initialize`参数是`true`，那么就会去初始化该类。有关于类的初始化相关的内容，可以复习一下[浅谈 Java 内存分配机制](https://oyst3r.top/posts/2024/06/01/%E6%B5%85%E8%B0%88Java%E5%86%85%E5%AD%98%E5%88%86%E9%85%8D%E6%9C%BA%E5%88%B6.html)，弄清楚类初始化过程中各个部分执行的先后顺序。
