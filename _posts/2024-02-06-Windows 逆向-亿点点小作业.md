...
![](images/image-44-1024x583.png)

然后可能会碰到这个报错，下面是解决办法

![](images/image-45-765x1024.png)

基本上就没什么大问题了，下面是成功的效果

![](images/image-42-1024x578.png)

![](images/image-46-1024x223.png)

这两个都是能打开正常运行的，但确实为啥变大了，但用二进制编辑器打开，前面那些伸缩的情况应该都正常，问题就是这个FakeNotePad.exe就是在结束的时候多了好多0x00，暂时还不懂原因

![](images/image-47-1024x449.png)

![](images/image-48-1024x410.png)

![](images/image-49-1024x557.png)

用PE解释器看了一下，说是有附加数据

![](images/Screenshot_1-1-1024x557.png)

![](images/Screenshot_2-1-1024x498.png)
